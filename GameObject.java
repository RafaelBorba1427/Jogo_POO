...
public class GameObject {
    ...
    GameObject(double x_pos, double y_pos, double width, double height, double rotation, double mass, boolean movable,
    ...
    public void drawHitbox(Graphics2D g2d) {
        // g2.drawImage(sprite, (int) position.x, (int) position.y, (int) dimensions.x,
        // (int) dimensions.y, null);
