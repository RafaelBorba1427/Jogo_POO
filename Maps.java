...
class Maps {
  ...
  static ArrayList<GameObject> generation(int i) {
    ...
    switch (i) {
      case 1:
        MovableObj obj_render_test7 = new MovableObj(1000f, 400f, 67, 40, 0, 1, GameRules.DEFAULT_FRICTION, true, true,
            true,
            GameObject.ID_PERMANENT_WALL, 0.3);
        MovableObj obj_render_test6 = new MovableObj(900f, 400f, 80, 180, 0, 1, GameRules.DEFAULT_FRICTION, true, true,
            true,
            GameObject.ID_PERMANENT_WALL, 0.3);
        MovableObj obj_render_test5 = new MovableObj(800f, 400f, 99, 300, 0, 1, GameRules.DEFAULT_FRICTION, true, true,
            true,
            GameObject.ID_PERMANENT_WALL, 0.3);
        MovableObj obj_render_test4 = new MovableObj(700f, 400f, 30, 400, 0, 1, GameRules.DEFAULT_FRICTION, true, true,
            true,
            GameObject.ID_PERMANENT_WALL, 0.3);
        RigidObj obj_render_test3 = new RigidObj(100f, 300f, 50f, 40f, (Math.PI / 4), GameRules.DEFAULT_FRICTION, true,
            true,
            GameObject.ID_PERMANENT_FLOOR);
